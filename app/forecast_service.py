...
class ForecastService:
    def predict_product(self, product, forecast_days, weather) -> dict:
        quantities = [item.salesQuantity for item in product.salesHistory]
        ...
        if not quantities:
            ...
            predicted_quantity = math.ceil(average_daily_sales * forecast_days * factor)
        ...
        return {
            ...
            "lowerBound": max(0, math.floor(predicted_quantity * 0.85)),
            "upperBound": math.ceil(predicted_quantity * 1.15),
