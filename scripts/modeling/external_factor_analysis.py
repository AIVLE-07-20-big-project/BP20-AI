...
EVENTS = DATA / "cultural_event.csv"
WEATHER = DATA / "weather_seoul_quarterly.csv"
EVENT_FEATURES = DATA / "event_exposure_quarterly.csv"
ANCHOR_RAW = DATA / "big_store.csv"
ANCHOR_FEATURES = DATA / "anchor_exposure_quarterly.csv"
SUBWAY_RAW_DIR = DATA / "subway_data"          # CARD_SUBWAY_MONTH_YYYYMM.csv (수동 확보, 일별 원본)
SUBWAY_STATIONS = DATA / "subway_stations.csv"  # 역 좌표(수집 단계 산출물)
SUBWAY_FEATURES = DATA / "subway_exposure_quarterly.csv"
